    ...
    <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-600 leading-relaxed mb-8 text-center">
          We understand that plans change. Here is how our cancellation policies
          work.
        </p>
        <div className="space-y-6">
          {[
            {
              type: "Flexible",
              desc: "Full refund if cancelled 24 hours before check-in.",
            },
            {
              type: "Moderate",
            ...
            {
              type: "Strict",
              desc: "No refund for cancellations made after 14 days of booking.",
            },
          ].map((policy) => (
            <div
              key={policy.type}
